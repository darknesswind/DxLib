...
extern	int		Graphics_D3D11_DrawSimpleTwoTriangleGraphF( const GRAPHICS_DRAW_DRAWSIMPLETWOTRIANGLEGRAPHF_PARAM *Param, IMAGEDATA *Image, IMAGEDATA *BlendImage )
{
	VERTEX_2D *Vect ;
	VERTEX_BLENDTEX_2D *VectB ;
	DWORD DiffuseColor ;
	...
	case VERTEXTYPE_BLENDTEX :	// ブレンドテクスチャを使用する
		...
		VectB[0].color = ( DWORD )DiffuseColor ;
		VectB[1].color = ( DWORD )DiffuseColor ;
		VectB[2].color = ( DWORD )DiffuseColor ;
		VectB[3].color = ( DWORD )DiffuseColor ;
		VectB[4].color = ( DWORD )DiffuseColor ;
		VectB[5].color = ( DWORD )DiffuseColor ;

		VectB[0].pos.x = Param->Vertex[ 0 ].x ; VectB[0].pos.y = Param->Vertex[ 0 ].y ; *((DWORD *)&VectB[0].pos.z) = drawz ;
		VectB[1].pos.x = Param->Vertex[ 1 ].x ; VectB[1].pos.y = Param->Vertex[ 1 ].y ; *((DWORD *)&VectB[1].pos.z) = drawz ;
		VectB[2].pos.x = Param->Vertex[ 2 ].x ; VectB[2].pos.y = Param->Vertex[ 2 ].y ; *((DWORD *)&VectB[2].pos.z) = drawz ;
		VectB[3].pos.x = Param->Vertex[ 3 ].x ; VectB[3].pos.y = Param->Vertex[ 3 ].y ; *((DWORD *)&VectB[3].pos.z) = drawz ;
		VectB[4].pos.x = Param->Vertex[ 2 ].x ; VectB[4].pos.y = Param->Vertex[ 2 ].y ; *((DWORD *)&VectB[4].pos.z) = drawz ;
		VectB[5].pos.x = Param->Vertex[ 1 ].x ; VectB[5].pos.y = Param->Vertex[ 1 ].y ; *((DWORD *)&VectB[5].pos.z) = drawz ;

		VectB[0].u2 = Param->Vertex[ 0 ].u ; VectB[0].v2 = Param->Vertex[ 0 ].v ;
		VectB[1].u2 = Param->Vertex[ 1 ].u ; VectB[1].v2 = Param->Vertex[ 1 ].v ;
		VectB[2].u2 = Param->Vertex[ 2 ].u ; VectB[2].v2 = Param->Vertex[ 2 ].v ;
		VectB[3].u2 = Param->Vertex[ 3 ].u ; VectB[3].v2 = Param->Vertex[ 3 ].v ;
		VectB[4].u2 = Param->Vertex[ 2 ].u ; VectB[4].v2 = Param->Vertex[ 2 ].v ;
		VectB[5].u2 = Param->Vertex[ 1 ].u ; VectB[5].v2 = Param->Vertex[ 1 ].v ;

		VectB[0].u1 = ( TexVect[0].x - BlendTexVect[0].x + GSYS.DrawSetting.BlendGraphX ) * GD3D11.Device.DrawSetting.InvBlendTextureWidth ;
		VectB[0].v1 = ( TexVect[0].y - BlendTexVect[0].y + GSYS.DrawSetting.BlendGraphY ) * GD3D11.Device.DrawSetting.InvBlendTextureHeight ;
		VectB[1].u1 = ( TexVect[1].x - BlendTexVect[1].x + GSYS.DrawSetting.BlendGraphX ) * GD3D11.Device.DrawSetting.InvBlendTextureWidth ;
		VectB[1].v1 = ( TexVect[1].y - BlendTexVect[1].y + GSYS.DrawSetting.BlendGraphY ) * GD3D11.Device.DrawSetting.InvBlendTextureHeight ;
		VectB[2].u1 = ( TexVect[2].x - BlendTexVect[2].x + GSYS.DrawSetting.BlendGraphX ) * GD3D11.Device.DrawSetting.InvBlendTextureWidth ;
		VectB[2].v1 = ( TexVect[2].y - BlendTexVect[2].y + GSYS.DrawSetting.BlendGraphY ) * GD3D11.Device.DrawSetting.InvBlendTextureHeight ;
		VectB[3].u1 = ( TexVect[3].x - BlendTexVect[3].x + GSYS.DrawSetting.BlendGraphX ) * GD3D11.Device.DrawSetting.InvBlendTextureWidth ;
		VectB[3].v1 = ( TexVect[3].y - BlendTexVect[3].y + GSYS.DrawSetting.BlendGraphY ) * GD3D11.Device.DrawSetting.InvBlendTextureHeight ;
		VectB[4].u1 = VectB[2].u1 ;
		VectB[4].v1 = VectB[2].v1 ;
		VectB[5].u1 = VectB[1].u1 ;
		VectB[5].v1 = VectB[1].v1 ;
	...
	case VERTEXTYPE_TEX :	// ブレンドテクスチャを使用しない
		...
		Vect[0].color = ( DWORD )DiffuseColor ;
		Vect[1].color = ( DWORD )DiffuseColor ;
		Vect[2].color = ( DWORD )DiffuseColor ;
		Vect[3].color = ( DWORD )DiffuseColor ;
		Vect[4].color = ( DWORD )DiffuseColor ;
		Vect[5].color = ( DWORD )DiffuseColor ;

		Vect[0].u = Param->Vertex[ 0 ].u ; Vect[0].v = Param->Vertex[ 0 ].v ;
		Vect[1].u = Param->Vertex[ 1 ].u ; Vect[1].v = Param->Vertex[ 1 ].v ;
		Vect[2].u = Param->Vertex[ 2 ].u ; Vect[2].v = Param->Vertex[ 2 ].v ;
		Vect[3].u = Param->Vertex[ 3 ].u ; Vect[3].v = Param->Vertex[ 3 ].v ;
		Vect[4].u = Param->Vertex[ 2 ].u ; Vect[4].v = Param->Vertex[ 2 ].v ;
		Vect[5].u = Param->Vertex[ 1 ].u ; Vect[5].v = Param->Vertex[ 1 ].v ;

		Vect[0].pos.x = Param->Vertex[ 0 ].x ; Vect[0].pos.y = Param->Vertex[ 0 ].y ; *((DWORD *)&Vect[0].pos.z) = drawz ;
		Vect[1].pos.x = Param->Vertex[ 1 ].x ; Vect[1].pos.y = Param->Vertex[ 1 ].y ; *((DWORD *)&Vect[1].pos.z) = drawz ;
		Vect[2].pos.x = Param->Vertex[ 2 ].x ; Vect[2].pos.y = Param->Vertex[ 2 ].y ; *((DWORD *)&Vect[2].pos.z) = drawz ;
		Vect[3].pos.x = Param->Vertex[ 3 ].x ; Vect[3].pos.y = Param->Vertex[ 3 ].y ; *((DWORD *)&Vect[3].pos.z) = drawz ;
		Vect[4].pos.x = Param->Vertex[ 2 ].x ; Vect[4].pos.y = Param->Vertex[ 2 ].y ; *((DWORD *)&Vect[4].pos.z) = drawz ;
		Vect[5].pos.x = Param->Vertex[ 1 ].x ; Vect[5].pos.y = Param->Vertex[ 1 ].y ; *((DWORD *)&Vect[5].pos.z) = drawz ;
...
#define DX_D3D11_CIRCLE																	\
			...
			{																			\
				...
				if( x2 > DrawRect.right - 1 ) x2 = DrawRect.right - 1 ;					\
																						\
				VectBuf[ VectNum ].pos.x  = ( float )x1 + 0.1f ;						\
				VectBuf[ VectNum ].pos.y  = ( float )y1 + 0.2f ;						\
				VectBuf[ VectNum ].color = Color ;										\
				VectBuf[ VectNum ].rhw   = 1.0f ;										\
				*((DWORD *)&VectBuf[ VectNum ].pos.z) = drawz ;							\
				VectNum ++ ;															\
