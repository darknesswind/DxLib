...
extern	int		Graphics_D3D9_DrawSimpleTwoTriangleGraphF( const GRAPHICS_DRAW_DRAWSIMPLETWOTRIANGLEGRAPHF_PARAM *Param, IMAGEDATA *Image, IMAGEDATA *BlendImage )
{
	VERTEX_2D *Vect ;
	VERTEX_BLENDTEX_2D *VectB ;
	DWORD DiffuseColor ;
	...
	case VERTEXTYPE_BLENDTEX :	// ブレンドテクスチャを使用する
		...
		VectB[0].u1 = ( TexVect[0].x - BlendTexVect[0].x + GSYS.DrawSetting.BlendGraphX ) * GD3D9.Device.DrawSetting.InvBlendTextureWidth ;
		VectB[0].v1 = ( TexVect[0].y - BlendTexVect[0].y + GSYS.DrawSetting.BlendGraphY ) * GD3D9.Device.DrawSetting.InvBlendTextureHeight ;
		VectB[1].u1 = ( TexVect[1].x - BlendTexVect[1].x + GSYS.DrawSetting.BlendGraphX ) * GD3D9.Device.DrawSetting.InvBlendTextureWidth ;
		VectB[1].v1 = ( TexVect[1].y - BlendTexVect[1].y + GSYS.DrawSetting.BlendGraphY ) * GD3D9.Device.DrawSetting.InvBlendTextureHeight ;
		VectB[2].u1 = ( TexVect[2].x - BlendTexVect[2].x + GSYS.DrawSetting.BlendGraphX ) * GD3D9.Device.DrawSetting.InvBlendTextureWidth ;
		VectB[2].v1 = ( TexVect[2].y - BlendTexVect[2].y + GSYS.DrawSetting.BlendGraphY ) * GD3D9.Device.DrawSetting.InvBlendTextureHeight ;
		VectB[3].u1 = ( TexVect[3].x - BlendTexVect[3].x + GSYS.DrawSetting.BlendGraphX ) * GD3D9.Device.DrawSetting.InvBlendTextureWidth ;
		VectB[3].v1 = ( TexVect[3].y - BlendTexVect[3].y + GSYS.DrawSetting.BlendGraphY ) * GD3D9.Device.DrawSetting.InvBlendTextureHeight ;
		VectB[4].u1 = VectB[2].u1 ;
		VectB[4].v1 = VectB[2].v1 ;
		VectB[5].u1 = VectB[1].u1 ;
		VectB[5].v1 = VectB[1].v1 ;
