...
extern	int		Graphics_D3D9_DrawSimpleTwoTriangleGraphF( const GRAPHICS_DRAW_DRAWSIMPLETWOTRIANGLEGRAPHF_PARAM *Param, IMAGEDATA *Image, IMAGEDATA *BlendImage ) ;											// ハードウエアアクセラレータ使用版 DrawSimpleTwoTriangleGraphF
